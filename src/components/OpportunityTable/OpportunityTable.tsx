...
export function OpportunityTable({ opportunities, onOpportunityClick }: OpportunityTableProps) {
  return (
          ...
          {opportunities.map((opportunity) => (
            ...
            >
              <td className="px-6 py-4 whitespace-nowrap">
                <div className="text-sm font-medium text-blue-600">{opportunity.name}</div>
              </td>
              <td className="px-6 py-4 whitespace-nowrap">
                <div className="text-sm text-gray-900">{opportunity.account}</div>
              </td>
              <td className="px-6 py-4 whitespace-nowrap">
